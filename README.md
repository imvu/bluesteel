...
For every benchmark definition and every commit of that benchmark definition's project, BlueSteel will create a Benchmark Execution. A Benchmark Execution will hold the results of the commands executed on a given commit, and a trail of Benchmark Execution results will show a chart of performance values.

All the output generated by the benchmark definition commands will be stored in the Benchmark Executions. BlueSteel can understand 3 types of outputs now:

**Text**

If the output of a command is a json string with the form below, BlueSteel will show a text on the benchmark execution page.
