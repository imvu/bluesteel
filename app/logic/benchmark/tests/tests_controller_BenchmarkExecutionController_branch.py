...
class BenchmarkExecutionControllerBranchTestCase(TestCase):
    ...
    def test_get_stacked_data_different_id(self):
        ...
        self.assertEqual(0.0, bench_data['id1'][0]['median'])
        self.assertEqual(0.0, bench_data['id1'][1]['median'])
        self.assertEqual(3.0, bench_data['id1'][2]['median'])
        ...
        self.assertEqual(0.0, bench_data['id2'][0]['median'])
        self.assertEqual(8.0, bench_data['id2'][1]['median'])
        self.assertEqual(0.0, bench_data['id2'][2]['median'])
        ...
        self.assertEqual(13.0, bench_data['id3'][0]['median'])
        self.assertEqual(0.0, bench_data['id3'][1]['median'])
        self.assertEqual(0.0, bench_data['id3'][2]['median'])
    ...
    def test_get_stacked_data_same_id(self):
        ...
        self.assertEqual(3, len(bench_data['id1']))
        self.assertEqual(3.0, bench_data['id1'][2]['median'])
        self.assertEqual(8.0, bench_data['id1'][1]['median'])
        self.assertEqual(13.0, bench_data['id1'][0]['median'])
        self.assertEqual(self.benchmark_execution1.id, bench_data['id1'][2]['benchmark_execution_id'])
    ...
    def test_get_stacked_data_multiple_id_per_execution(self):
        ...
        self.assertEqual(0.0, bench_data['id4'][0]['median'])
        self.assertEqual(0.0, bench_data['id4'][1]['median'])
        self.assertEqual(23.0, bench_data['id4'][2]['median'])
        ...
        self.assertEqual(0.0, bench_data['id6'][0]['median'])
        self.assertEqual(33.0, bench_data['id6'][1]['median'])
        self.assertEqual(0.0, bench_data['id6'][2]['median'])
        ...
        self.assertEqual(53.0, bench_data['id8'][0]['median'])
        self.assertEqual(0.0, bench_data['id8'][1]['median'])
        self.assertEqual(0.0, bench_data['id8'][2]['median'])
    ...
    def test_bar_color_depending_on_branch(self):
        ...
        self.assertEqual(1.0, bench_data['id1'][0]['median'])
        self.assertEqual(2.0, bench_data['id1'][1]['median'])
        self.assertEqual(3.0, bench_data['id1'][2]['median'])
        self.assertEqual(4.0, bench_data['id1'][3]['median'])
        self.assertEqual(5.0, bench_data['id1'][4]['median'])
        self.assertEqual(6.0, bench_data['id1'][5]['median'])
    ...
    def test_one_benchmark_exection_invalidated(self):
        ...
        self.benchmark_execution2.report = report_2
        self.benchmark_execution3.report = report_3
        self.benchmark_execution3.revision_target = 28
