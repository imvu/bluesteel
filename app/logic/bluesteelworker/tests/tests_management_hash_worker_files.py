...
class ManagementHashWorkerFilesTestCase(TestCase):
    ...
    def test_call_command(self):
        ...
        self.assertEqual(1, WorkerFilesHashEntry.objects.filter(files_hash='b53ee9d96bc7efde04fa16d0be7ab0875ac0dd69').count())


    def test_hash_files_inside_folder(self):
        self.create_files_to_hash()

        sha_hash = FileHasher.get_hash_from_files_in_a_folder(self.folder_to_hash)
