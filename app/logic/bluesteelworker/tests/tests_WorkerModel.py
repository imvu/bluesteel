...
class WorkerModelTestCase(TestCase):
    ...
    def test_get_max_feed_reports_names_and_values(self):
        ...
        self.assertEqual('1 Reports', names[0]['name'])
        self.assertEqual('5 Reports', names[1]['name'])
        self.assertEqual('10 Reports', names[2]['name'])
        self.assertEqual('20 Reports', names[3]['name'])
        self.assertEqual('30 Reports', names[4]['name'])
        self.assertEqual('40 Reports', names[5]['name'])
        self.assertEqual('50 Reports', names[6]['name'])
        self.assertEqual('100 Reports', names[7]['name'])
        ...
        self.assertTrue(names[4]['current'])
