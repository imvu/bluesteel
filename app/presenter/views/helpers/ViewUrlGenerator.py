...
def get_layout_project_list_url(layout_id):
    return '/main/layout/{0}/projects/list/'.format(layout_id)
...
def get_project_definition_list_url(project_id):
    return '/main/project/{0}/definition/list/'.format(project_id)
...
def get_duplicate_benchmark_definition_url(benchmark_definition_id):
    return '/main/definition/{0}/duplicate/'.format(benchmark_definition_id)
...
def get_feed_purge_all_reports_url(worker_id):
    return '/main/feed/report/worker/{0}/purge/all/'.format(worker_id)

def get_feed_purge_old_reports_url(worker_id, keep_young_count):
    return '/main/feed/report/worker/{0}/purge/keep/{1}/'.format(worker_id, keep_young_count)
