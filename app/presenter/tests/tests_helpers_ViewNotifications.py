...
class NotificationHelperTestCase(TestCase):
    ...
    def test_notifying_on_command_failure(self):
        ...
        self.assertFalse('out-1' in StackedMailEntry.objects.filter(sender='bluesteel@bluesteel.com', receiver='a@b.c').first().content)
        self.assertFalse('error-1' in StackedMailEntry.objects.filter(sender='bluesteel@bluesteel.com', receiver='a@b.c').first().content)
        ...
        self.assertFalse('out-1' in StackedMailEntry.objects.filter(sender='bluesteel@bluesteel.com', receiver='user2@test.com').first().content)
        self.assertFalse('error-1' in StackedMailEntry.objects.filter(sender='bluesteel@bluesteel.com', receiver='user2@test.com').first().content)
